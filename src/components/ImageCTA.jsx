export default function ImageCTA({children, image}) {
   return (
      <div className="transition-colors duration-700 max-w-xl w-fit font-light text-2xl mt-2 px-5 leading-tight text-slate-800 dark:text-slate-200 md:px-0 md:pr-5 lg:text-3xl">
